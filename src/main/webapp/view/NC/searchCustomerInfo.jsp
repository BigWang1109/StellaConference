        ...
        <table class="table-search">
            <div style="padding-top: 5px;padding-left: 10px;">
                ...
                <input class="easyui-combobox"
                       ...
                       id="vname"
                       <%--data-options="--%>
                            <%--url:'<%=path%>/nc/initializeOption/vname',--%>
                            <%--method:'post',--%>
                            <%--valueField:'vname',--%>
                            <%--textField:'vname',--%>
                            <%--value:0,--%>
                ...
                <input class="easyui-combobox"
                       ...
                       id="fcustype"
                       <%--data-options="--%>
                            <%--url:'<%=path%>/nc/initializeOption/fcustype',--%>
                            <%--method:'post',--%>
                            <%--valueField:'fcustype',--%>
                            <%--textField:'fcustype',--%>
                            <%--value:0,--%>
                ...
                <input class="easyui-combobox"
                       ...
                       id="fproceedingtype"
                       <%--data-options="--%>
                            <%--url:'<%=path%>/nc/initializeOption/fproceedingtype',--%>
                            <%--method:'post',--%>
                            <%--valueField:'fproceedingtype',--%>
                            <%--textField:'fproceedingtype',--%>
                            <%--value:0,--%>
                ...
                <%--<a class="easyui-linkbutton easyui-linkbutton-primary" href="javascript:void(0);" onclick="exportExcel()">导出Excel</a>--%>
            </div>
        </table>
    </form>
