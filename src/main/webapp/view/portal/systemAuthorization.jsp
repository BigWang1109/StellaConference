  ...
  <SCRIPT LANGUAGE="JavaScript">
    ...
    function getNodeByClick(event,treeId,treeNode){
      ...
      if(type == 'Department'){
        ...
        getMemberByAccount(treeNode.id)
      }
    }
...
//        }
    ...
    function getMemberByAccount(ORG_ACCOUNT_ID){
      $('#grid').datagrid({
        striped: false,
        fitColumns: true,
        resizable: true,
        singleSelect: false,
        url: '<%=path%>/portal/loadOrgMemberByAccountId/'+ORG_ACCOUNT_ID+'',
        idField: 'ID',
        sortName: 'CODE',
        sortOrder: 'asc',
        remoteSort: true,
  ...
  <div class="main">
    ...
    <div class="main_body">
      <div class="mian_table">
        <div class="easyui-panel" title="人员列表" style="width: 300%;" data-options="region:'center'" >
          <form id = "form-search">
          ...
          <div style="text-align:center; padding-bottom:5px;">
            <a href="javascript:void(0)" style="margin-top: 5px;"align="center" class="easyui-linkbutton easyui-linkbutton-primary" onClick="peopleBatchAuth()">保存</a>
            <a href="javascript:void(0)" style="margin-top: 5px;" class="easyui-linkbutton easyui-linkbutton-primary" onClick="">取消</a>
