      ...
      <div class="mian_table">
        <div class="easyui-panel" title="人员列表" style="width: 100%;" data-options="region:'center'" >
          ...
          <div style="text-align:center; padding-bottom:5px;">
            <a href="javascript:void(0)" style="margin-top: 5px;"align="center" class="easyui-linkbutton easyui-linkbutton-primary" onClick="peopleBatchAuth()">批量授权</a>
            <a href="javascript:void(0)" style="margin-top: 5px;" class="easyui-linkbutton easyui-linkbutton-primary" onClick="">批量取消授权</a>
